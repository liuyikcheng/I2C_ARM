...
//GPIO_NO_PULL_UP_DOWN GPIO_PULL_UP
	...
	configDMAM2M(dma1, channel3, P2M);

	DMA_memcpy8(dma1,&(I2C3_reg->I2C_DR),buffer,1);
...
/**********
		...
		//	i2cWriteData(0x18, I2C_reg);
			...
			while(1);
***************/
	data = I2C3_reg->I2C_CR2;
//	i2cWriteData(0x21, I2C3_reg);
	generateStart(I2C3_reg);
	data = I2C3_reg->I2C_CR2;
	//sendAddress(I2C3_reg, 0x2D, ADDRESS_7_BIT_MODE, MASTER_TRANSMIT);
	I2C3_reg->I2C_CR2 |= (1<<11);	// dma enable
